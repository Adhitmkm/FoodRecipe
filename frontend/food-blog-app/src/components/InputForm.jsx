...
export default function InputForm({setIsOpen}) {
   ...
   const handleOnSubmit= async(e)=>{
    e.preventDefault()
    let endpoint = (isSignUp) ? "signUp" : "login" // ith aan nammal postmanil kodukkuna end points
  ...
  return (
    ...
    <form className='form' onSubmit={handleOnSubmit}>
        ...
        <p onClick={()=>setIsSignUp(pre=>!pre)}>{(isSignUp) ? "Alredy have an account" : "Create new account"} </p>
    </form>
    </>
  )
}
